...
✓ TBDATE from RPVBDATA: 20251201
  Date: 2025-12-01 → REPTDATE: 2025-11-30 → PREVDATE: 2025-10-31
  REPTDT (MMYY): 1125
  PREVDT (MMYY): 1025
...
✓ RPVB1: 1207 records
  Columns: ['RECID', 'MNIACTNO', 'LOANNOTE', 'NAME', 'ACCTSTA', 'PRODTYPE', 'PRSTCOND', 'REGCARD', 'IGNTKEY', 'REPODIST', 'ACCTWOFF', 'MODEREPO', 'REPOPAID', 'REPOSTAT', 'TKEPRICE', 'MRKTVAL', 'RSVPRICE', 'FTHSCHLD', 'MODEDISP', 'APPVDISP', 'HOPRICE', 'NOAUCT', 'PRIOUT', 'DATEWOFF', 'DATEREPO', 'DATE5TH', 'DATEAPRV', 'DATESTLD', 'DATEHO']
...
└───────┴────────────┴──────────┴──────────────────────────┴───┴────────────┴──────────┴────────────┴────────┘
✓ RPVB2: 776 records (ACCTSTA in D,S,R)
✓ RPVB3: 776 records (with DATESTLD)

============================================================
STEP 6-7: Creating REPO and REPOWH datasets
============================================================
Previous: /sas/python/virt_edw/Data_Warehouse/MIS/Job/LOAN/output/REPO/REPS_1025.parquet
Current: /sas/python/virt_edw/Data_Warehouse/MIS/Job/LOAN/output/REPO/REPS_1125.parquet
ℹ No previous data: No such file or directory (os error 2): /sas/python/virt_edw/Data_Warehouse/MIS/Job/LOAN/output/REPO/REPS_1025.parquet

This error occurred with the following context stack:
        [1] 'parquet scan'
        [2] 'sink'

  Combined: 776 new + 0 previous = 776 total
✓ Saved REPO: 776 records
✓ Saved REPOWH: 776 records (0 duplicates removed)
