...
def process_large_loan_bill_scd(
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        if input_ln_bill.exists() and input_iln_bill.exists():
            ...
            print(f"  ✓ Loaded historical data from previous day")
        else:
        ...
        for i, chunk_file in enumerate(chunk_files):
            ...
            chunk_result = process_scd_chunk(
                con, chunk_file, REPTDATE, PREVDATE, temp_path, f"chunk_{i}", has_historical_data
            )
