...
PARQUET_FILE = "EIBMRNID_DATA.parquet"  # Parquet output
...
def main():
    ...
    # Apply format REMFMTA - FIXED: Create columns in separate steps
    # First create heldmkt
    tbl1 = tbl1_filtered.with_columns([
        pl.lit(0).alias('heldmkt')
    ])
    
    # Then create outstanding using heldmkt
