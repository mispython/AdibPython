"""
EIBWTRBL - Simplified Billings Transaction Processing
"""
...
df_sas, meta = pyreadstat.read_sas7bdat(f'{BASE_PATH}/LOAN/REPTDATE/reptdate.sas7bdat')
...
extcomm_path = f'{BASE_PATH}/EXTCOMM/extcomm.txt'
