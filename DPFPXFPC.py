...
def eibrp159():
    ...
    if len(npgs_df) > 0:
        ...
        # Save as SAS7BDAT
        try:
            # First try pyreadstat (simpler and more reliable)
            ...
            try:
                ...
                # Save as SAS7BDAT using proper SAS code
                output_dir = str(output_sas7bdat_path.parent)
                ...
                print(f"saspy also failed: {e2}")
                print("Could not create SAS7BDAT file")
