...
if len(lines) > 0:
    ...
    if len(date_str) >= 8:
        try:
            ...
            # Allow for the possibility that the file might be from a different day
            if gl != rdate:
                ...
                # Option 1: Strict check - exit if dates don't match
                # sys.exit(77)
                
                # Option 2: Use the file date instead of yesterday's date
