...
if len(dcid) > 0:
    ...
    print(f"After join - columns: {dcid2.columns}")
    print(f"After join - records: {len(dcid2)}")

    # Update CUSTCODE if found in reference tables
    # Check if CUSTCODE2 column exists before using it
    if "CUSTCODE2" in dcid2.columns:
        ...
        print("WARNING: CUSTCODE2 column not found after join!")
