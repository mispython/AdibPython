...
SAS Connection established. Subprocess id is 41716
...
/sas/python/virt_edw_dev/lib64/python3.9/site-packages/saspy/sasiostdio.py:1118: UserWarning: Noticed 'ERROR:' in LOG, you ought to take a look and see if there was a problem
  warnings.warn("Noticed 'ERROR:' in LOG, you ought to take a look and see if there was a problem")
/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBRTLIO.py:222: DeprecationWarning: `pl.count()` is deprecated. Please use `pl.len()` instead.
(Deprecated in version 0.20.5)
  summary = df.group_by("cvar02").agg(pl.count().alias("count"))
Report saved to /sas/python/virt_edw/Data_Warehouse/MIS/XMIS/output/EIBRTLIO/sc167r.txt
Processing complete. Output files written to: /sas/python/virt_edw/Data_Warehouse/MIS/XMIS/output/EIBRTLIO
Files: tl.parquet, tl.sas7bdat, sc167t.txt, npgs3.parquet, npgs3.sas7bdat, sc167r.txt
SAS Connection terminated. Subprocess id was 41716
