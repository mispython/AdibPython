...
# =============================================================================
# OUTPUT: PRINT REPORT (COSTXT02) — %PRNRPT1
# =============================================================================
...
def write_print_report(totsum: pl.DataFrame, rv: dict, output_path: str):
    ...
    Writes fixed-width formatted report with ASA carriage control.
    """
    if totsum.is_empty():
        print("  WARNING: No data for print report")
        return
...
# =============================================================================
# OUTPUT: COSTEXP — Exception report
# =============================================================================
...
# =============================================================================
# OUTPUT: MISSING ACCOUNT NAMES
# =============================================================================

def write_missname_report(missname: pl.DataFrame, output_path: str):
    """
    PROC PRINT DATA=MISSNAME VAR ACCTNO equivalent.
    Appended to COSTXT02 report file.
    """
    if missname.is_empty():
        print("  No missing account names")
        return
        
    if 'acctno' in missname.columns:
