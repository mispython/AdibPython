        ...
        for branch in branches:
            ...
            for icno in icnos:
                ...
                for row in ic_df.iter_rows(named=True):
                    ...
                    # This should give us spaces before the number
                    ...
                    # Write the detail line with proper spacing
                    # ACCTNO: 12 chars, NOTENO: 6 chars, NAME: 30 chars, TYPE: 4 chars, STATUS: 6 chars
                    # BALANCE: 14 chars (right aligned), PASS DUE: 6 chars (right aligned with spaces), DATE: 8 chars
