...
def load_remit():
    ...
    try:
        ...
        unclaim = pl.read_parquet(f"{PATHS['UNCLAIM']}UNCLAIM{['reptyear']}.parquet")
...
def main():
    ...
    if not saca.is_empty():
        ...
        write_csv(trustee_high, "TRUSTEE >60000", "trustee_high.csv")
        write_csv(trustee_low, "TRUSTEE <=60000", "trustee_low.csv")
    ...
    if not client_df.is_empty() and not saca.is_empty():
        ...
        write_client_csv(client_high, "CLIENT >60000", "client_high.csv")
        write_client_csv(client_low, "CLIENT â‰¤60000", "client_low.csv")
