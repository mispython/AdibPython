...
LOAN_LNNOTE   = "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/input/prod/EIBAABBA/lnnote.sas7bdat"
BNM_LOAN       = "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/input/prod/EIBMHPFS/ln{REPTMON}{NOWK}{REPTYEAR}.sas7bdat"    
...
UPDATED CODE. below is sas original code:
