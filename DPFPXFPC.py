//EIBMREPO JOB MISEIS,CLASS=A,MSGCLASS=A,NOTIFY=&SYSUID                 00010003
//**                                                                    00020003
//** SMR 2010-246  (NRA)                                                00030003
//** SMR 2014-2832 (MFM)                                                00031003
//**                                                                    00032003
//DELETE EXEC PGM=IEFBR14                                               00033003
//DEL01  DD  DSN=SAP.PBB.RPDATAWH,                                      00034003
//           DISP=(MOD,DELETE,DELETE),                                  00035003
//           SPACE=(CYL,(0))                                            00036003
//DEL02  DD  DSN=SAP.PBB.RPDATAWH.RPFTP,                                00037003
//           DISP=(MOD,DELETE,DELETE),                                  00038003
//           SPACE=(CYL,(0))                                            00039003
//**                                                                    00040003
//CREATE EXEC PGM=IEFBR14                                               00050003
//CRT01  DD  DSN=SAP.PBB.RPDATAWH.RPFTP,                                00060003
//           DISP=(NEW,CATLG,DELETE),                                   00070003
//           DCB=(RECFM=FB,LRECL=80,BLKSIZE=24000),                     00080003
//           SPACE=(CYL,(200,200),RLSE),UNIT=(SYSDA,5)                  00090003
//**                                                                    00100003
//EIBMRPWH EXEC SAS609                                                  00110003
//RPVBDATA DD DSN=SAP.PBB.RPVB.TEXT,DISP=SHR                            00120003
//SRSDATA  DD DSN=RBP2.B033.SRSCTRL1(0),DISP=SHR                        00130003
//REPOWH   DD DSN=SAP.PBB.RPDATAWH,                                     00140003
//            DISP=(NEW,CATLG,DELETE),                                  00150003
//            DCB=(RECFM=FS,LRECL=27648,BLKSIZE=27648),                 00160003
//            SPACE=(CYL,(200,200),RLSE),UNIT=(SYSDA,5)                 00170003
//REPO     DD DSN=SAP.RPVB.DATA,DISP=OLD                                00180003
//SYSIN    DD *                                                         00190003
                                                                        00200003
OPTIONS NOCENTER YEARCUTOFF=1950;                                       00210003
                                                                        00220003
...
RUN;                                                                    01210003
                                                                        01220003
FILENAME TRANFILE 'SAP.PBB.RPDATAWH.RPFTP' DISP=OLD;                    01230003
PROC CPORT LIBRARY=REPOWH FILE=TRANFILE;                                01240003
RUN;                                                                    01250003
                                                                        01260003
