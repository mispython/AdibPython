========== START JOB EIBWHP02 ==========
[INFO] REPTDATE=2026-07-30 -> {'NOWK': '4', 'NOWK1': '3', 'REPTMON': '07', 'REPTMON1': '07', 'REPTYEAR': '2026', 'REPTDAY': '30', 'RDATE': '30/07/26', 'SDATE': '23/07/26'}
...
/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBWHP02.py:446: FutureWarning: The behavior of DataFrame concatenation with empty or all-NA entries is deprecated. In a future version, this will no longer exclude empty or all-NA columns when determining the result dtypes. To retain the old behavior, exclude the relevant entries before the concat operation.
...
[DEBUG] rows matching SMI_CUSTCD ['41', '44', '48', '52']: 97 of 310
[SYSOUT] Report written to spool: /sas/python/virt_edw/Data_Warehouse/MIS/XMIS/output/EIBWHP02/EIBWHP02_20260731_105725.txt
