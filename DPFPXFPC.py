...
# Input files
# NOTE: REPTDATE is no longer read from a file (see get_reptdate()).
...
INTRA_GROUP_PATH = LIST_DIR / "icof_mni_intra_group.sas7bdat"
RELATED_PARTY_PATH = LIST_DIR / "icof_mni_related_party.sas7bdat"
EQU_INTRA_GROUP_PATH = LIST_DIR / "icof_equ_intra_group.sas7bdat"
EQU_RELATED_PARTY_PATH = LIST_DIR / "icof_equ_related_party.sas7bdat"
...
def create_summaries(cof_combined):
    ...
    # (e.g. 4.01-4.04, 5.01-5.03) have a blank PART2, so SAS never produces
