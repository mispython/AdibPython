...
/* ARE AFFECTED : SADENOM, SAPROD (SAVINGS DEPOSITS)             */
/*                FDDENOM, FDPROD (FIXED DEPOSITS)               */
/*                CDDENOM, CAPROD (CURRENT ACCOUNTS)             */
/*****************************************************************/
/** AMENDMENT  : 11/05/04                                      ***/
/** DONE BY    : RHA - A497                                    ***/
/** REASON : TO ADD & REMAP PRODUCT 182(STAFF AL-WADIAH CA)    ***/
/**          AND 166(CASH LINE FACILITY) IN FISS RDAL REPORT   ***/
/**          PRODUCT 166 -REMAP FRM BNM BIC CODE '42110' TO    ***/
/**                       '42310'                              ***/
...
/** SMR 2016-2905 NFJ 09-08-16 UPD INTPLAN 778,779,862,863,    ***/
/**                                895,337,338,339             ***/
/** SMR 2016-4627 TBC 14-12-16 RM CA 20 AND FCYCA 420:431      ***/
/**     2016-4623              RM CA 21 AND FCYCA 450:454      ***/
...
/** SMR 2018-0254 SAM 25-01-18 PLUS FD 895,337,904,905,        ***/
/**                                    994,995,996,997         ***/
/**                            & TDI   338,339,599,659,        ***/
/**                                    229,230,231,232         ***/
...
%LET ACE=(40,42,43,150,151,152,181);  /* ACE PRODUCTS CODES */
%LET FCY=(350,351,352,353,354,355,356,357,358,360,361,362); /*EIBWFCWH*/

%LET CURX=(050,051,055,056,057,058,060,064,065,068,069,167,169,168,
           085,086,087,088,089,066,067,070,071,073,096,097,061,090,
           091,092,093,094,095,100,101,102,106,108,109,110,111,112,
           113,114,115,116,117,118,119,120,121,122,123,124,125,133,
           134,135,137,138,170,150,151,152,153,154,155,156,157,158,
           159,160,161,162,163,164,165,166,174,175,176,177,178,179,
           180,181,182,183,189,190,191,192,193,194,195,196,197,198,
           081,082,083,084,184,185,186,131,132,187,188,020,021,077,
           040,041,042,043,078,074,35,36,37,38,39,46,47,48,49,75,
           076,023,024,025,045,026,027,013,014,015,016,017,018,019,
           003,004,005,006,007,008,009,010,011,012,022,081);

PROC FORMAT;
   VALUE SADENOM   /* SA DENOMINATION OF ISLAMIC OR DOMESTIC */
     204   = 'I'   /* ISLAMIC */
     207   = 'I'   /* ISLAMIC */
     214   = 'I'   /* ISLAMIC */
     215   = 'I'   /* ISLAMIC */
   ...
   VALUE SAPROD
     ...
     483    = 'N'       /* EGOLD INVESTMENT ACCOUNT (NON-STAFF) */
     484    = 'N'       /* EGOLD INVESTMENT ACCOUNT (STAFF) */
     OTHER  = '42120';  /* ALL OTHER SAVING CODES    */

   VALUE FDDENOM   /* FD DENOMINATION OF ISLAMIC OR DOMESTIC */
     229-232 = 'I'  /* ISLAMIC */
     272-283 = 'I'  /* ISLAMIC */
     334-336 = 'I'  /* ISLAMIC */
     338-339 = 'I'  /* ISLAMIC */
   ...
   VALUE FDPROD
     ...
     OTHER  = '42130';  /* ALL OTHER FD CODES       */
   ...
   VALUE FDPRODD
     ...
     OTHER  = '42130';  /* OTHERS, IF ANY            */

   VALUE FDPRD
     300-319,400-419,368-394,500-539,600-639,
     741-744,445                             ='N'  /*  FD NORMAL   */
     320-339,420-428,540-547                 ='L'  /*  FD LIFE     */
     340-359,453-459,461-469,580-599         ='M'  /*  FD MGIA     */
     660-740                                 ='M'  /*  FD MGIA-PFB */
     OTHER                                   =' ';

   INVALUE FCYTERM    /* FCY TERM BASE ON INTPLAN */
     470,471,476,477,482,483,488,494,548,554,
     ...
     431,435,758                                             = 6
     444,446,545-547,560-566,573,427,754,766,770,
     774,432,436                                             =12;

   VALUE CADENOM    /* CA DENOMINATION OF ISLAMIC OR DOMESTIC */
     20,21,32,33,60,61,62,63,64,66,67,70,71,73,75,76,92,93,96,97,80,
     23,24,25,321,13,14,15-19,7,8,81,
     160-169,182-188,74,46,47,48,49,45  = 'I'  /* ISLAMIC */
     OTHER                           = 'D'; /* DOMESTIC */
  ...
  /* 200   = 'B'         JALAN SK10/4, SERI KEMBANGAN (JSK)  */
  ...
  VALUE FDORGMT
   ...
   VALUE FDRMMT
     LOW - 0    = '51'  /* REM. MAT. OVERDUE       */
     0   - 1    = '52'  /* REM. MAT. <= 1 MTH      */
     1   - 2    = '53'  /* REM. MAT. > 1 - 2 MTHS  */
     2   - 3    = '54'  /* REM. MAT. > 2 - 3 MTHS  */
     3   - 6    = '55'  /* REM. MAT. > 3 - 6 MTHS  */
     6   - 9    = '56'  /* REM. MAT. > 6 - 9 MTHS  */
     9   - 12   = '57'  /* REM. MAT. > 9 - 12 MTHS */
     12  - 24   = '61'  /* REM. MAT. > 1 - 2 YEARS */
     24  - 36   = '62'  /* REM. MAT. > 2 - 3 YEARS */
     36  - 48   = '63'  /* REM. MAT. > 3 - 4 YEARS */
     48  - 60   = '64'  /* REM. MAT. > 4 - 5 YEARS */
     60  - HIGH = '70'; /* REM. MAT. > 5 YEARS     */
...
which version is more closer to the original sas code?
