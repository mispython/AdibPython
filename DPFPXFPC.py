...
//BTFILE    DD DSN=SAP.PBB.SASCCRIS.BTPM12.TEXT,DISP=SHR
//BASE      DD DSN=SAP.PBB.CCRIS.BTBASE,DISP=SHR
//DAYBTRD   DD DSN=SAP.PBB.CCRIS2.DAYBTRD.PM12,
