...
print(f"DESC after CR mapping: {desc.shape[0]} rows")
...
print("Sample CINSTCL values:", coll['CINSTCL'].value_counts().head(10))
print("Sample NATGUAR values:", coll['NATGUAR'].value_counts().head(10))

coll = coll[(coll['CINSTCL']=='18') & (coll['NATGUAR']=='06')]
print(f"COLL after filtering (CINSTCL=18, NATGUAR=06): {coll.shape[0]} rows")
...
if dep.empty:
    ...
    print("Sample ACCTNO from COLL:", coll['ACCTNO'].head(10).tolist())
...
if dep.empty:
    ...
    print(f"DEP after CVAR02 mapping: {dep.shape[0]} rows")
