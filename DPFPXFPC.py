...
# Show CUSTCODE distribution for debugging
print("\nCUSTCODE distribution in summary:")
custcode_dist = alm_summary.group_by("CUSTCODE_STR").agg([
...
# ==================== GENERATE REPORTS ====================
def generate_report(data, bic_prefix, title, combine_by_code=True):
    ...
    # If combine_by_code is True, group by BNMCODE (which already combines CUSTCODE and RM)
    ...
    with open(report_file, 'w') as f:
        ...
        # Production-style output with Obs column
