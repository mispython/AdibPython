...
# ============================================================================
# FUNCTION TO SAVE SAS DATASET USING PYREADSTAT
# ============================================================================

def save_sas_dataset(df, dataset_name, output_dir):
    """Save DataFrame as SAS dataset using pyreadstat"""
    try:
        ...
        # Write SAS file using pyreadstat
        pyreadstat.write_sas7bdat(
            df_sas, 
            f'{output_dir}/{dataset_name}.sas7bdat',
            column_labels={col: col for col in df_sas.columns}
        )
