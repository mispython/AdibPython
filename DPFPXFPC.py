# eibdcitx.py - FIXED FORMATTING FUNCTIONS
import polars as pl
...
def to_float(val):
    """Safely convert a value to float, handling strings"""
    if val is None:
        return None
    try:
        return float(val)
...
def to_int(val):
    """Safely convert a value to int, handling strings"""
    if val is None:
        return None
    try:
...
# ===================================================================
# DCITXT FORMATTING - SAFE TYPE CONVERSION
# ===================================================================
