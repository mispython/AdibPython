...
Traceback (most recent call last):
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIIWBTCR_ISLAMIC_WEEKLY_BANKTRADE_CCR.py", line 672, in <module>
...
polars.exceptions.DuplicateError: column 'ficode_right' is duplicate
