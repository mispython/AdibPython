...
def save_sas_dataset(df, dataset_name, output_dir):
    ...
    try:
        ...
        # Method 1: Try using sasdata directly
        try:
            ...
            # Method 2: Alternative using SAS submit
            print(f"  Attempting alternative method...")
            
            # First, upload the dataframe to SAS WORK library
            sas_df = sas.sasdata(df_sas, dataset_name)
            
            # Then use SAS to save it permanently
            sas.submit(f"""
