...
PRODTYPE not found in BTDTL, using PRODGRP instead
Traceback (most recent call last):
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBD2CBT.py", line 98, in <module>
...
Traceback (most recent call last):
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBD2CBT.py", line 118, in <module>
    btdtl_trans = con.execute("""
_duckdb.ConversionException: Conversion Error: Could not convert string 'SG' to INT32 when casting from source column PRODGRP

LINE 14:                    ELSE CAST(PRODGRP AS INT)
                                 ^
