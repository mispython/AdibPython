...
STEP 1: DEBUG - Checking BORSTAT values...
  Reading: lnnote.sas7bdat - 500000 rows, 1.8s
...
STEP 3: Reading IIS and SP data...
  ...
  Reading: sp2.sas7bdat - 135725 rows, 0.3s
  IIS rows: 135725
  SP rows: 135725
...
STEP 5: Reading CCRIS data...
  ...
  Reading: icredmsubac0726.sas7bdat - 500000 rows, 22.4s
...
STEP 6: Reading HPD loan data...
  Reading: lnnote.sas7bdat - 500000 rows, 2.2s
  HPD loan rows: 2093
...
STEP 8: Calculating derived fields...
  Reading: lnnote.sas7bdat - 500000 rows, 5.0s
  Calculations completed in 6.5s
  Loan records: 135728

STEP 9: Reading customer names...
  Reading: loan.sas7bdat - 500000 rows, 1.2s
  Customer names: 314388

STEP 10: Reading guarantor information...
  Reading: lnliab07226.sas7bdat - 500000 rows, 0.3s
...
shape: (1, 9)
┌──────────┬─────────┬─────────┬────────┬───┬─────────┬───────┬────────┬─────┐
│ ACCTNO   ┆ NOTENO  ┆ BORSTAT ┆ DAYS   ┆ … ┆ PAIDIND ┆ TOTAL ┆ TOTIIS ┆ SP  │
│ ---      ┆ ---     ┆ ---     ┆ ---    ┆   ┆ ---     ┆ ---   ┆ ---    ┆ --- │
│ f64      ┆ f64     ┆ str     ┆ f64    ┆   ┆ str     ┆ f64   ┆ f64    ┆ f64 │
╞══════════╪═════════╪═════════╪════════╪═══╪═════════╪═══════╪════════╪═════╡
│ 2.9702e9 ┆ 90010.0 ┆ null    ┆ 2630.0 ┆ … ┆ null    ┆ 0.0   ┆ 0.0    ┆ 0.0 │
└──────────┴─────────┴─────────┴────────┴───┴─────────┴───────┴────────┴─────┘

  Active accounts (BORSTAT='A'):
shape: (3, 7)
┌────────┬────────┬─────────┬──────┬──────────┬─────────┬─────────┐
│ ACCTNO ┆ NOTENO ┆ BORSTAT ┆ DAYS ┆ LOANTYPE ┆ PAIDIND ┆ TOTAL   │
│ ---    ┆ ---    ┆ ---     ┆ ---  ┆ ---      ┆ ---     ┆ ---     │
│ f64    ┆ f64    ┆ str     ┆ f64  ┆ f64      ┆ str     ┆ f64     │
╞════════╪════════╪═════════╪══════╪══════════╪═════════╪═════════╡
│ null   ┆ null   ┆ A       ┆ null ┆ null     ┆ P       ┆ 0.0     │
│ null   ┆ null   ┆ A       ┆ null ┆ null     ┆ M       ┆ 1436.07 │
│ null   ┆ null   ┆ A       ┆ null ┆ null     ┆ M       ┆ 1865.51 │
└────────┴────────┴─────────┴──────┴──────────┴─────────┴─────────┘

  Accounts with DAYS >= 334 and TOTAL != 0: 0
  Accounts with BORSTAT in ['F','I'] and TOTAL != 0: 0
  Active accounts with TOTAL != 0: 2
  Accounts with BORSTAT in ['F','I'] (any DAYS): 0
  ==================================================
