...
this is the conventional version from the previous EIIQLIQP. remove the reptdate input, use datetime timedelta - 1 instead. fdmthly input in sas7bdat sas dataset format (all lowercase). output in text file
