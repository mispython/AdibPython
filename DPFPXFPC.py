        ...
        for branch in branches:
            ...
            for icno in icnos:
                ...
                for row in ic_df.iter_rows(named=True):
                    # Format ACCTNO - exactly 12 chars (left aligned)
                    ...
                    # Format NOTENO - exactly 6 chars (left aligned)
                    ...
                    # Customer name - exactly 30 chars (left aligned)
                    custname = (str(row.get('CUSTNAME', '') or '')[:30]).ljust(30)
                    
                    # Product type - exactly 4 chars (left aligned)
