...
# Add netproc column to loan0 if it doesn't exist
...
# Define column specifications (following SAS code exactly)
coll_specs = [
...
# DESC: Use record length 298 (max position in SAS code)
DESC_RECORD_LENGTH = 298
...
try:
    ...
    # Sort and join (following SAS: PROC SORT; BY CCOLLNO; then MERGE)
    ...
    # Filter (following SAS: IF CINSTCL='18' AND NATGUAR='06')
...
micr_specs = [
    ("pendbrh", 1, 3, "numeric"),   # @001 PENDBRH 3.
