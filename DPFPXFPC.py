...
# Input files
LOAN_NOTE_FILE = Path("/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/input/prod/EIBRCGCS/enrh_ln_note_m{REPTMON}.sas7bdat") # WHERE ENTITY_CD != "PIBB"
LOANI_NOTE_FILE = Path("/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/input/prod/EIBRCGCS/enrh_ln_note_m{REPTMON}.sas7bdat") # WHERE ENTITY_CD = "PIBB"
LOAN_COMM_FILE = Path("/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/input/prod/EIBLSMEZ/enrh_ln_comm_m{REPTMON}.sas7bdat") # WHERE ENTITY_CD != "PIBB"
LOANI_COMM_FILE = Path("/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/input/prod/EIBLSMEZ/enrh_ln_comm_m{REPTMON}.sas7bdat") # WHERE ENTITY_CD = "PIBB"
