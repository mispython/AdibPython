...
remove the reptdate. use datetime timedelta - 1 instead. lnnote input are in sas7bdat for both pbb and pibb. use pyreadstat to read sas dataset. output in text file. for lnnote pbb, the input file is 20gb (around 6million data), may use chunks or any other efficient ways to improve the efficiency and fast readable.
