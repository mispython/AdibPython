...
KeyError: 'ISSDTE_curr'

The above exception was the direct cause of the following exception:

Traceback (most recent call last):
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBWHP02.py", line 365, in <module>
    run_job()
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBWHP02.py", line 347, in run_job
    alw = build_alw(loan_prev_path, loan_curr_path)
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBWHP02.py", line 213, in build_alw
