...
Traceback (most recent call last):
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBLSMEZ.py", line 464, in <module>
...
polars.exceptions.SchemaError: datatypes of join keys don't match - `ccollno`: str on left does not match `ccollno`: f64 on right (and no other type was available to cast to)
