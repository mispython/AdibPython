...
def eibrsmee():
    ...
    # 'curbal', 'costctr', 'accrual', 'balance', 'product', 'censust', 'sch', 
    # 'cinstcl', 'natguar', 'tranche', 'cvar02', 'cvar01', 'cvar06', 'cvar03', 
    # 'cvar04', 'cvar14', 'cvar13', 'cvar08', 'cvar09', 'cvar10', 'cvar11', 
    # 'cvar05', 'cvar07', 'cvar12', 'cvar15', 'branch'
