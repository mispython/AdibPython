...
Loading input files...
  ...
  Found 1720 records of 856 bytes each
  Error loading CRA: invalid literal for int() with base 10: ''
  Packed decimal parser failed: invalid literal for int() with base 10: ''
  Falling back to fixed-width parser...
  ✓ Loaded CRA using fixed-width parser: 1 rows
...
└────────┴─────────────────────────────────┴──────────┴─────────────────────────────────┴───┴───────┴────────────┴────────┴──────────────┘
  Available INV_STATUS values: ['\x00\x00\x00']
...
SAS Connection established. Subprocess id is 980839
...
================================================================================
SAS Connection terminated. Subprocess id was 980839
