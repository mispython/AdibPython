...
SAS Connection established. Subprocess id is 2260509

Error creating SAS7BDAT file: 'DataFrame' object has no attribute 'strip'
Please check SAS configuration and permissions

Summary:
MEFT.txt file created with 10 records
Report saved to MEFR.txt
SAS Connection terminated. Subprocess id was 2260509
