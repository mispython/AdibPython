Traceback (most recent call last):
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIIQFISF_ISLAMIC_INSURANCE.py", line 16, in <module>
    pbbdpfmt.process()
AttributeError: module 'PBBDPFMT' has no attribute 'process'


below are PBBDPFMT.py
