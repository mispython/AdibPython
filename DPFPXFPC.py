//EIMIR102 JOB MSGCLASS=X,MSGLEVEL=(1,1),REGION=8M                      JOB02003
/*JOBPARM S=S1M1
//*
//*********************************************************************
//* OLD PROGRAM  : LNCCD002
//* FUNCTION     : LOANS IN ARREARS REPORT FOR HPCCD
//*                (THE MONTH-END VERSION)
//* MODIFY       : 01 MAR 2006 ESMR 2005-610
//*********************************************************************
//*
//EIMAR102  EXEC SAS609
...
//BNM       DD DSN=SAP.PIBB.CCDTEMP(0),DISP=SHR
//PGM       DD DSN=SAP.BNM.PROGRAM,DISP=SHR
//CCDTXT2   DD DSN=SAP.PIBB.CCDTXT2,DISP=MOD
//SYSIN     DD *
