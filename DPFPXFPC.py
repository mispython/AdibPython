...
Processing Client Accounts...
  Found CLIENT as SAS dataset: /sas/python/virt_edw/Data_Warehouse/MIS/XMIS/input/prod/EIIQINST/client.sas7bdat
  CLIENT SAS file appears to be pre-processed
  CLIENT columns: ['acctno', 'name', 'branch', 'product', 'curbal', 'intpaybl', 'float', 'avbal', 'avbaltt', 'prodcd', 'amtind', '_type_', '_freq_', 'plusbal', 'unclaim', 'cheqno', 'issbranch', 'status', 'issdte', 'category', 'si', 'ibgamt']
  CLIENT master: 617 rows
  Client data appears to be pre-processed
  Using pre-processed client data directly
  Client >60k: 281 accounts
  Client <=60k: 336 accounts
  Output written to: /sas/python/virt_edw/Data_Warehouse/MIS/XMIS/output/EIIQINST/islamic_client_high.txt
  Output written to: /sas/python/virt_edw/Data_Warehouse/MIS/XMIS/output/EIIQINST/islamic_client_low.txt
