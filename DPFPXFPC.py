Available attributes in PBBDPFMT:
  ACE: set
  ACE_PRODUCTS: set
  CADenomFormat: function
  CAProductFormat: function
  CURX: set
  CURX_PRODUCTS: set
  Dict: function
  FCY: set
  FCYTermFormat: function
  FCY_PRODUCTS: set
  FDDenomFormat: function
  FDProductFormat: function
  List: function
  Optional: function
  ProductLists: function
  SADenomFormat: function
  SAProductFormat: function
  Set: function
  Tuple: function
  apply_format: function
  branchcd_format: function
  cadenom_format: function
  caprod_format: function
  ddcustcd_format: function
  ddrange_format: function
  dpcustcd_format: function
  fcyterm_format: function
  fdcustcd_format: function
  fddenom_format: function
  fdorgmt_format: function
  fdprd_format: function
  fdprod_format: function
  fdprodd_format: function
  fdrmmt_format: function
  get_format: function
  ifdcuscd_format: function
  race_format: function
  rmfdorgmt_format: function
  s1range_format: function
  s2range_format: function
  sacustcd_format: function
  sadenom_format: function
  saprod_format: function
  sdrange_format: function
  statecd_format: function

Processing for month: 07 (Report Date: 2026-07-30)
Report Date based on: current date minus 1 day
Traceback (most recent call last):
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBMTRUT.py", line 199, in <module>
    SA = apply_sas_format(SA, source_col="PRODUCT", format_dict=SAPROD, out_col="PRODCD")
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBMTRUT.py", line 96, in apply_sas_format
  ...
  File "/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBMTRUT.py", line 98, in <lambda>
    lambda x: format_dict(x) if x is not None else None,
TypeError: SAProductFormat() takes no arguments


below is the PBBDPFMT.py
