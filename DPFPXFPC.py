...
def main():
    ...
    if rept_day == "01":
        ...
        # Write SAS file - use pyreadstat.write_sas7bdat
        try:
            ...
            try:
                ...
                print("Warning: Could not write SAS file. Make sure pyreadstat is installed correctly.")
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        print("Warning: Could not write SAS file.")
