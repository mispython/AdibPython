...
_duckdb.BinderException: Binder Error: Alias with name "PRODTYPE" exists, but aliases cannot be used as part of an expression in the GROUP BY

LINE 6:              ELSE CAST(PRODTYPE AS INT)
                               ^
