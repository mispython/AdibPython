...
try:
    ...
    # First strip any whitespace and convert to float
    coll = coll.with_columns([
        pl.col("acctno").str.strip().cast(pl.Float64).alias("acctno"),
        pl.col("noteno").str.strip().cast(pl.Float64).alias("noteno")
    ])
