...
/sas/python/virt_edw/Data_Warehouse/MIS/XMIS/EIBDMSFX.py:157: FutureWarning: The behavior of DataFrame concatenation with empty or all-NA entries is deprecated. In a future version, this will no longer exclude empty or all-NA columns when determining the result dtypes. To retain the old behavior, exclude the relevant entries before the concat operation.
...
SAS Connection established. Subprocess id is 1110913

   saspy method failed: 'SASsession' object has no attribute 'sasdata2sd2'
   pyreadstat method failed: module 'pyreadstat' has no attribute 'write_sas7bdat'
...
✅ Updated files:
   ...
   /sas/python/virt_edw/Data_Warehouse/MIS/XMIS/output/EIBDMSFX/NLF06.sas7bdat
...
============================================================
SAS Connection terminated. Subprocess id was 1110913
