#!/usr/bin/env python3
"""
EIIDNLHA - Hardcode Data Transpose and Categorization
...
print("Processing EIIDNLHA - Hardcode Transpose and Categorization")
...
# Apply negative multiplier for specific products
con.execute("""
...
# ============================================================================
print("\nTransposed Data:")
print(con.execute("SELECT * FROM hardcode").df())
...
# ============================================================================
# OUTPUT to STORE.HARDFXP1 - Products starting with '94' and ITEM starts with 'B'
# ============================================================================
con.execute("""
...
# ============================================================================
# OUTPUT to STORE.HARDFXP2 - Products starting with '96' and ITEM starts with 'B'
# ============================================================================
con.execute("""
