"""
EIFFCCD2 - Islamic CCD Reports Controller (Production Ready)
...
2. LNCCDI02 - CCD Islamic transaction report
3. LNCCDI04 - CCD Islamic summary report
...
print("EIIFCCD2 - Islamic CCD Reports Controller")
print("=" * 60)
...
programs = [
    ...
    ('LNCCDI02', 'Islamic CCD Transaction Report'),
    ('LNCCDI04', 'Islamic CCD Summary Report')
]
